        ...
        >
          ...
          <>
            <Flex w="100%" mt="10px" mb="10px" justify={signup ? "center" : "space-between"}>
              {
                signup ?
                  ...
                  <>
                    ...
                    <Button onClick={guestSign} borderRadius='20px' w="50%" size="sm" >visiteur</Button>
                  </>
              }
            </Flex>
            ...
            >
              ...
              <Text fontSize="sm">Se connecter avec google</Text>
            </Flex>
            <Flex mt="15px">
              <Text fontSize="sm">{signup ? "Vous avez un compte ?" : "nouveau?"} </Text>
              <Text
                ...
                ml="5px"
              >
                {signup ? "Login" : "creation de compte"}
              </Text>
            </Flex>
          </>
        </Flex>
